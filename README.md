...
```sh
curl -fsSL https://raw.githubusercontent.com/Boursyt/img2ascii/refs/heads/main/install/install.sh | bash
```
...
```powershell
$script = Join-Path $env:TEMP "install-img2ascii.ps1"; curl.exe -fsSL https://raw.githubusercontent.com/Boursyt/img2ascii/refs/heads/main/install/install.ps1 -o $script; powershell -ExecutionPolicy Bypass -NoProfile -File $script
```
...
```sh
curl -fsSL https://raw.githubusercontent.com/Boursyt/img2ascii/refs/heads/main/install/install.sh | INSTALL_DIR="$HOME/.local/bin" bash
```
